...
namespace Web.Controllers
{
    public class WorkoutController : Controller
    {
        ...
        {
            var wHD = new WorkoutHistory(_fittifyContext, workoutId);
            return RedirectToAction("HistoryDetails", "Workout", new { workoutHistoryId = wHD.Id });
        }
        ...
        {
            var wls = new WeightLiftingSet(_fittifyContext, exerciseHistoryId);
        ...
        {
            var exerciseHistory = new ExerciseHistory(_fittifyContext, workoutHistoryId, exerciseId);
