...
{
    public class WorkoutRepository : AsyncCrudBase<Workout, int>, IAsyncEntityOwnerIntId
    {
        ...
        public async Task<PagedList<Workout>> GetPagedCollection(WorkoutResourceParameters ofmResourceParameters)
        {
