...
{
    public class ApiControllerTestCaseDataForSingleOfmForGet<T> where T : class
    {
        public int IdParameter { get; set; } = 1;
        public string FieldsParameter { get; set; } = "";

        public string TestCaseDescription { get; set; }
        public OfmForGetQueryResult<T> ReturnedTOfmForGetQueryResultMock { get; set; }
