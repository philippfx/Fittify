...
{
    public class ApiControllerTestCaseDataForOfmForPatch<TEntity, TOfmForPatch, TOfmForGet, TId>
        where TEntity : class
        ...
        where TId : struct
    {
        ...
        public JsonPatchDocument<TOfmForPatch> IncomingJsonPatchDocumentForCategoryOfmForPatch { get; set; }
        public TOfmForPatch YetUntouchedOfmForPatchReturnedFromOfmRepo { get; set; }
        public TOfmForPatch PatchedOfmForPatch { get; set; }
        public TOfmForGet ReturnedTOfmForGetMockAfterPatch { get; set; }
