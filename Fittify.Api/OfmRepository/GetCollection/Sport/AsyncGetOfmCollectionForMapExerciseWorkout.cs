...
{
    public class AsyncGetOfmCollectionForMapExerciseWorkout : AsyncGetOfmByIdOwned<MapExerciseWorkoutRepository, MapExerciseWorkout, MapExerciseWorkoutOfmForGet, int>
    {
        ...
        public virtual async Task<OfmForGetCollectionQueryResult<MapExerciseWorkoutOfmForGet>> GetCollection(MapExerciseWorkoutResourceParameters resourceParameters, Guid ownerGuid)
        {
