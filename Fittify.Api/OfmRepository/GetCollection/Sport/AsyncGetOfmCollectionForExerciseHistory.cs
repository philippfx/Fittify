...
{
    public class AsyncGetOfmCollectionForExerciseHistory : AsyncGetOfmByIdOwned<ExerciseHistoryRepository, ExerciseHistory, ExerciseHistoryOfmForGet, int>
    {
        ...
        public virtual async Task<OfmForGetCollectionQueryResult<ExerciseHistoryOfmForGet>> GetCollection(ExerciseHistoryResourceParameters resourceParameters, Guid ownerGuid)
        {
