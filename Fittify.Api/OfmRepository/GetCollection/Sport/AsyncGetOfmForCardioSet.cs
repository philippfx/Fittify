...
//{
//    public class AsyncGetOfmForCardioSet : AsyncGetOfmById<CardioSetRepository, CardioSet, CardioSetOfmForGet, int, CardioSetResourceParameters>,
//        IAsyncGetOfmCollection<CardioSetOfmForGet, int, CardioSetResourceParameters>
//    {
