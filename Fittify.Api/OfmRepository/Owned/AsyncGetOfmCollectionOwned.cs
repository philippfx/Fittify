...
{
    public class AsyncGetOfmCollectionOwned<TCrudRepository, TEntity, TOfmForGet, TId> : IAsyncGetOfmCollectionOwned<TOfmForGet>
        where TOfmForGet : class, IEntityUniqueIdentifier<TId>
        where TId : struct
        where TEntity : class, IEntityUniqueIdentifier<TId>
        where TCrudRepository : class, IAsyncCrudOwned<TEntity, TId>, IAsyncGetCollectionOwned<TEntity, TId>
    {
        ...
        public AsyncGetOfmCollectionOwned(TCrudRepository repository,
        ...
        public virtual async Task<OfmForGetCollectionQueryResult<TOfmForGet>> GetCollection(IResourceParameters resourceParameters, Guid ownerGuid)
        {
            ...
            var pagedListEntityCollection = Repo.GetCollection(resourceParameters, ownerGuid);
