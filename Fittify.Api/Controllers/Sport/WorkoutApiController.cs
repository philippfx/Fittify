...
namespace Fittify.Api.Controllers.Sport
{
    ...
    {
        private readonly IAsyncGetOfmById<WorkoutOfmForGet, int> _asyncGetOfmById;
        private readonly IAsyncGetOfmCollectionByNameSearch<WorkoutOfmForGet> _asyncGetOfmCollectionIncludeByNameSearch;
            ...
            IHttpContextAccessor httpContextAccesor)
        {
            ...
            _asyncGetOfmById = new AsyncGetOfmCollectionIncludeByNameSearch<WorkoutRepository, Workout, WorkoutOfmForGet, int>(_repo, urlHelper, adcProvider, propertyMappingService, typeHelperService, this);
            _asyncGetOfmCollectionIncludeByNameSearch = new AsyncGetOfmCollectionIncludeByNameSearch<WorkoutRepository, Workout, WorkoutOfmForGet, int>(_repo, urlHelper, adcProvider, propertyMappingService, typeHelperService, this);
