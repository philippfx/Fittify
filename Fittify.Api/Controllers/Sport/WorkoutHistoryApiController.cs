...
//        private readonly IAsyncGetOfmCollectionByDateTimeStartEnd<WorkoutHistoryOfmForGet, int> _asyncGetOfm;
...
//            _asyncPostPatchDeleteForHttpMethods = new AsyncPostPatchDeleteOfm<WorkoutHistoryRepository, WorkoutHistory, WorkoutHistoryOfmForGet, WorkoutHistoryOfmForPost, WorkoutHistoryOfmForPatch, int>(_repo, urlHelper, adcProvider, nameof(WorkoutHistoryApiController));
//            _asyncGetOfm = new AsyncGetOfmCollectionIncludeByDateTimeStartEnd<WorkoutHistoryRepository, WorkoutHistory, WorkoutHistoryOfmForGet, int>(_repo, urlHelper, adcProvider, propertyMappingService, typeHelperService, nameof(WorkoutHistoryApiController));
