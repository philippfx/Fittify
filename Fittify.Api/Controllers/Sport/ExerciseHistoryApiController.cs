...
namespace Fittify.Api.Controllers.Sport
{
        ...
        IAsyncDeleteForHttp<int>
    {
        ...
        private readonly IAsyncPostOfmOwned<ExerciseHistoryOfmForGet, ExerciseHistoryOfmForPost> _asyncPostForHttpMethods;
        private readonly IAsyncPatchOfmOwned<ExerciseHistoryOfmForGet, ExerciseHistoryOfmForPatch, int> _asyncPatchForHttpMethods;
            ...
            IHttpContextAccessor httpContextAccesor)
        {
            ...
            _asyncPostForHttpMethods = new AsyncPostOfmOwned<ExerciseHistoryRepository, ExerciseHistory, ExerciseHistoryOfmForGet, ExerciseHistoryOfmForPost, int>(_repo);
            _asyncPatchForHttpMethods = new AsyncPatchOfmOwned<ExerciseHistoryRepository, ExerciseHistory, ExerciseHistoryOfmForGet, ExerciseHistoryOfmForPatch, int>(_repo);
            _asyncDeleteForHttpMethods = new AsyncDeleteOfmOwned<ExerciseHistoryRepository, ExerciseHistory, int>(_repo, adcProvider);
