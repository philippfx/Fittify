...
namespace Fittify.Api.Controllers.Sport
{
        ...
        IAsyncDeleteForHttp<int>
    {
        ...
        private readonly IAsyncPostOfmOwned<MapExerciseWorkoutOfmForGet, MapExerciseWorkoutOfmForPost> _asyncPostForHttpMethods;
        private readonly IAsyncPatchOfmOwned<MapExerciseWorkoutOfmForGet, MapExerciseWorkoutOfmForPatch, int> _asyncPatchForHttpMethods;
            ...
            IHttpContextAccessor httpContextAccesor)
        {
            ...
            _asyncPostForHttpMethods = new AsyncPostOfmOwned<MapExerciseWorkoutRepository, MapExerciseWorkout, MapExerciseWorkoutOfmForGet, MapExerciseWorkoutOfmForPost, int>(_repo);
            _asyncPatchForHttpMethods = new AsyncPatchOfmOwned<MapExerciseWorkoutRepository, MapExerciseWorkout, MapExerciseWorkoutOfmForGet, MapExerciseWorkoutOfmForPatch, int>(_repo);
            _asyncDeleteForHttpMethods = new AsyncDeleteOfmOwned<MapExerciseWorkoutRepository, MapExerciseWorkout, int>(_repo, adcProvider);
        ...
        public async Task<IActionResult> GetCollection(MapExerciseWorkoutResourceParameters resourceParameters)
        {
            ...
            dynamic result = new
            {
                ...
                links = _hateoasLinkFactory.CreateLinksForOfmGetForMapExerciseWorkout(resourceParameters,
