...
namespace Fittify.Api.Controllers.Sport
{
        ...
        IAsyncDeleteForHttp<int>
    {
        ...
        private readonly IAsyncPostOfmOwned<WeightLiftingSetOfmForGet, WeightLiftingSetOfmForPost> _asyncPostForHttpMethods;
        private readonly IAsyncPatchOfmOwned<WeightLiftingSetOfmForGet, WeightLiftingSetOfmForPatch, int> _asyncPatchForHttpMethods;
            ...
            IHttpContextAccessor httpContextAccesor)
        {
            ...
            _asyncPostForHttpMethods = new AsyncPostOfmOwned<WeightLiftingSetRepository, WeightLiftingSet, WeightLiftingSetOfmForGet, WeightLiftingSetOfmForPost, int>(_repo);
            _asyncPatchForHttpMethods = new AsyncPatchOfmOwned<WeightLiftingSetRepository, WeightLiftingSet, WeightLiftingSetOfmForGet, WeightLiftingSetOfmForPatch, int>(_repo);
            _asyncDeleteForHttpMethods = new AsyncDeleteOfmOwned<WeightLiftingSetRepository, WeightLiftingSet, int>(_repo, adcProvider);
