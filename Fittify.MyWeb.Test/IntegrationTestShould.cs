...
namespace Fittify.MyWeb.Test
{
    ...
    public class IntegrationTestShould
    {
        ...
        public TestServer GetClientTestServerInstance(TestServer apiTestServer) // With Api-Test-Server's httpClient injected
        {
            ...
            // 2. .proj file must be adjusted, see http://www.dotnetcurry.com/aspnet-core/1420/integration-testing-aspnet-core (or references for view rendering are missing)
