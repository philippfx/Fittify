...
{
    public class ExerciseHistoryOfmRepository : AsyncOfmRepositoryBase<ExerciseHistory, ExerciseHistoryOfmForGet, int, ExerciseHistoryResourceParameters>, IAsyncOfmOwnerIntId
    {
