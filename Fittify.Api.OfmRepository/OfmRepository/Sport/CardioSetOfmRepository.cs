...
{
    public class CardioSetOfmRepository : AsyncGppdBase<CardioSet, CardioSetOfmForGet, CardioSetOfmForPost, CardioSetOfmForPatch, int, CardioSetOfmResourceParameters, CardioSetResourceParameters>, IAsyncOwnerIntId
    {
