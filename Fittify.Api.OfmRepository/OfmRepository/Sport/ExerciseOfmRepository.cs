...
{
    public class ExerciseOfmRepository : AsyncGppdBase<Exercise, ExerciseOfmForGet, ExerciseOfmForPost, ExerciseOfmForPatch, int, ExerciseOfmResourceParameters, ExerciseResourceParameters>
    {
