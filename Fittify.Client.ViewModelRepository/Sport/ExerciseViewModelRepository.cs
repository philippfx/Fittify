...
{
    public class ExerciseViewModelRepository : ViewModelRepositoryBase<int, ExerciseViewModel, ExerciseOfmForGet, ExerciseOfmForPost, ExerciseOfmCollectionResourceParameters>
    {
