...
namespace Fittify
{
    public class Startup
    {
        ...
        {
            services.AddMvc();
            services.AddSingleton<IWorkoutSessionViewModelData, WorkoutSessionViewModelMockData>();
            services.AddSingleton<IWorkoutSession, WorkoutSessionMockData>();
            ...
            //services.AddDbContext<FittifyContext>(options => options.UseSqlServer(@"Server=.\SQLEXPRESS;Database=Fittify;Trusted_Connection=True;MultipleActiveResultSets=true"));
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                await context.Response.WriteAsync("Hello World from startup.cs!");
            });
        }
