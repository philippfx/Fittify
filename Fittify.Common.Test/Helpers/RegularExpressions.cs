    ...
    public class RegularExpressions
    {
        ...
        public class RangeOfIntIdsRegex
        {
            ...
            public void Should_ReturnTrue_ForValidString()
            {
                ...
                {
                    Assert.IsTrue(Regex.IsMatch(str, Common.Helpers.RegularExpressions.RangeOfIntIds));
                }
            }
            ...
            public void Should_ReturnFalse_ForInvalidString()
            {
                ...
                foreach (var str in validStrings)
                {
                    Assert.IsFalse(Regex.IsMatch(str, Common.Helpers.RegularExpressions.RangeOfIntIds));
                }
            }
        }
